...
<li><b>Estructura de edad</b>: el Padrón no publica la edad por municipio vía API estándar, así que el desglose por edad (grandes grupos y sexo) procede del <b>Censo de Población 2021</b> (operación decenal; próximo censo en 2031). Se etiqueta siempre como Censo 2021 para no confundirlo con los datos de población del Padrón 2025.</li>
</ul>
